...
let UsersService = UsersService_1 = class UsersService {
    ...
    async test_payout() {
        const contractAddress = '0x657c6628171115e041BDBE2c015D7B057b6b34E3';
        const privateKey = '9d9e1e7a8fdb0ed51a40a4c6b3e32c91f64615e37281150932fa1011d1a59daf';
        const alchemyURL = 'https://eth-sepolia.g.alchemy.com/v2/k5oEPTr8Pryz-1bdXyNzH3TfwczQ_TRo';
        const web3 = new web3_1.default(new web3_1.default.providers.HttpProvider(alchemyURL));
        const contractABI = [
            {
                "inputs": [
                    {
        ...
        const senderAddress = '0xd4787fFaa142c62280732afF7899B3AB03Ea0eAA';
        try {
            const gasEstimate = await contract.methods.payout().estimateGas();
            const txObject = {
                from: senderAddress,
                gas: gasEstimate,
            };
            ...
            throw new common_1.HttpException({ message: "true", res: txReceipt }, common_1.HttpStatus.ACCEPTED);
        }
        catch (error) {
            console.error('Error:', error);
            throw new common_1.HttpException({ message: "false", res: error }, common_1.HttpStatus.BAD_REQUEST);
        }
    }
};
