...
let PayoutServices = PayoutServices_1 = class PayoutServices {
    constructor(userModel, payoutRepository) {
        this.userModel = userModel;
        this.payoutRepository = payoutRepository;
        this.logger = new common_1.Logger(PayoutServices_1.name);
    }
    createPayout(userId) { }
    getPayout(payoutId) { }
...
PayoutServices = PayoutServices_1 = __decorate([
