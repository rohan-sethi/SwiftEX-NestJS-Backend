...
let AppModule = class AppModule {
    configure(consumer) {
        consumer
            ...
            .exclude('users/login', 'users/register', 'transactions/webhook', 'transactions/webhook/connect', 'users/verifyLoginOtp')
            .forRoutes(users_controller_1.UsersController, offers_controller_1.OffersController, bids_controller_1.BidsController, transactions_controller_1.TransactionsController, chain_controller_1.ChainController, payout_controller_1.PayoutController);
    }
};
