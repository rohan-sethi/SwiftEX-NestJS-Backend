...
UserModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: user_schema_1.User.name, schema: user_schema_1.UserSchema }, { name: user_wallets_schema_1.UserWallet.name, schema: user_wallets_schema_1.UserWalletSchema }])],
